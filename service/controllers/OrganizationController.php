...
class OrganizationController extends BaseController
{
    ...
    /**
     * @api {get} /service/organization/list  组织列表(公司/场馆/部门)
     * @apiName        1会员列表
    ...
    /**
     * @api {get} /service/organization/employee-count  公司/场馆员工数
     * @apiName        3公司/场馆员工数
     * @apiGroup       organization
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/service/organization/employee-count
         * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    ...
    /**
     * @api {get} /service/organization/     所有场馆列表(权限内的)
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/service/organization/venues
      * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
