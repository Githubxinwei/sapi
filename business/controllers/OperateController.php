...
use business\models\EntryRecord;
...
class OperateController extends BaseController
{
    ...
    /**
     * @api {get} /business/operate/entry-count  到店人数统计
     * @apiName        1到店人数统计
     * @apiGroup       operate
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/operate/entry-count
    ...
    /**
     * @api {get} /business/operate/entry-table  到店统计报表
     * @apiName        2到店统计报表
     * @apiGroup       operate
     * @apiParam  {string}            date       可选，默认当日，"2017-12-03"
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2018/01/03
     * @apiSampleRequest  http://apiqa.aixingfu.net/operate/entry-table
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）

    {
        ...
        "data": {
            ...
            "_links": {
                "self": {
                    "href": "http://127.0.0.3/business/operate/entry-table?accesstoken=000_1544587932&date=2017-12-06&page=1"
                },
                "next": {
                    "href": "http://127.0.0.3/business/operate/entry-table?accesstoken=000_1544587932&date=2017-12-06&page=2"
                },
                "last": {
                    "href": "http://127.0.0.3/business/operate/entry-table?accesstoken=000_1544587932&date=2017-12-06&page=12"
                }
            },
            "_meta": {
                "totalCount": 231,
    ...
    /**
     * @api {get} /business/operate/category-count  到店卡种统计
     * @apiName        3到店卡种统计
     * @apiGroup       operate
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2018/01/03
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/operate/category-count
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）

    {
        ...
        "data": {
            ...
            "_links": {
                "self": {
                    "href": "http://127.0.0.3/business/operate/category-count?accesstoken=000_1544587932&page=1"
                },
                "next": {
                    "href": "http://127.0.0.3/business/operate/category-count?accesstoken=000_1544587932&page=2"
                },
                "last": {
                    "href": "http://127.0.0.3/business/operate/category-count?accesstoken=000_1544587932&page=6"
                }
            },
            "_meta": {
                "totalCount": "116",
    ...
    /**
     * @api {get} /business/operate/class-count  会员上课统计
     * @apiName        4会员上课统计
     * @apiGroup       operate
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2018/01/03
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/operate/class-count
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
