...
use business\models\FindPwdForm;
use business\models\LoginCodeForm;
use business\models\LoginForm;
use business\models\RegisterForm;
...
class SiteController extends BaseController
{
    ...
    /**
     * @api {post} /business/site/login   登录
     * @apiName        1登录
     * @apiGroup       site
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/site/login
    ...
    /**
     * @api {post} /business/site/find-pwd   找回密码
     * @apiName        4找回密码
     * @apiGroup       site
     * @apiParam  {string}        mobile         手机号码
     * @apiParam  {string}        code           验证码
