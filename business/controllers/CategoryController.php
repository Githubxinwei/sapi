...
{
    public $modelClass = 'business\models\Category';
    ...
    /**
     * @api {get} /business/category/table  卡种收入统计报表
     * @apiName        1卡种收入统计报表
     * @apiGroup       category
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/category/table
    ...
    public function actionTable()
    {
        ...
        $query = Order::find()->where(['venue_id'=>$venue_id, 'status'=>2, 'note'=>['售卡', '续费', '升级', '办卡', '迈步一体机售卡']]);
     ...
     /**
     * @api {get} /business/category/behaviors  交费行为列表
     * @apiName        9交费行为列表
     * @apiGroup       category
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsports.club
     * <span><strong>创建时间：</strong></span>2018/01/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/category/behaviors
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    ...
    /**
     * @api {get} /business/categories/:id  卡种详情
     * @apiName        4卡种详情
     * @apiGroup       category
     * @apiDescription   卡种详情
     * <br/>
