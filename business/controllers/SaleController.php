...
{
    /**
     * @api {get} /business/sale/count  销售统计
     * @apiName        1销售统计
     * @apiGroup       sale
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/count
    ...
    public function actionCount()
    {
        ...
        $params['venue_id'] = $venue_id = $this->getFilterVenueId();
        ...
        if($type == 'd'){
            $query = Order::find()->where(['venue_id'=>$venue_id, 'status'=>2])->andWhere(['between', 'pay_money_time', $start, $end]);
            $orders = $query->all();
            $data = [];
    ...
    /**
     * @api {get} /business/sale/table  销售报表
     * @apiName        2销售报表
     * @apiGroup       sale
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsports.club
     * <span><strong>创建时间：</strong></span>2018/01/08
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/table
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    ...
    public function actionTable()
    {
        ...
        return new ActiveDataProvider(['query' => $query]);
         ...
         /**
     * @api {get} /business/sale/behaviors  商品类型列表
     * @apiName        2商品类型列表
     * @apiGroup       sale
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/behaviors
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    ...
    public function actionBehaviors()
    {
     ...
     /**
     * @api {get} /business/sale/position  员工业绩统计
     * @apiName        3员工业绩统计
     * @apiGroup       sale
     * @apiParam  {string}            type       日期类别：d 日、w 周 、m 月 、s 季度 、y 年
      *@apiParam  {string}            venue_id   场馆ID
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsports.club
     * <span><strong>创建时间：</strong></span>2018/01/08
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/position
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    {
        "message": "",
    ...
    /**
     * @api {get} /business/sale/rank  销售排行榜
     * @apiName        4销售排行榜
     * @apiGroup       sale
     * @apiParam  {string}            type       日期类别：d 日、w 周 、m 月 、s 季度 、y 年
     * @apiParam  {string}            venue_id   场馆ID
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsports.club
     * <span><strong>创建时间：</strong></span>2018/01/08
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/rank
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    ...
    {
        $params['venue_id'] = $this->getFilterVenueId();
        ...
        /**
     * @api {get} /business/sale/about-count  课程预约统计
     * @apiName        5课程预约统计
     * @apiGroup       sale
     * @apiParam  {string}            type       日期类别：d 日、w 周 、m 月 、s 季度 、y 年
     * @apiParam  {string}            venue_id   场馆ID
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/business/sale/about-count
         * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
