...
use coach\models\AboutClassIndex;
use coach\models\AboutClassView;
...
class ClassController extends AuthBaseController
{

    /**
     * @api {get} /coach/class/index?accesstoken=666   上课列表/上课搜索
     * @apiVersion  1.0.0
     * @apiName        上课列表/上课搜索
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/index?accesstoken=666
...

    {
        ...
        $query->orderBy('ac.is_read asc, ac.id desc');
    ...
    /**
     * @api {get} /coach/class/view?accesstoken=666   上课详情
     * @apiVersion  1.0.0
     * @apiName        上课详情
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/view?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
    {
    ...
    /**
     * @api {get} /coach/class/in?accesstoken=666   上课打卡
     * @apiVersion  1.0.0
     * @apiName        上课打卡.
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/in?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
     * {
    ...
    /**
     * @api {get} /coach/class/out?accesstoken=666   下课打卡
     * @apiVersion  1.0.0
     * @apiName        .下课打卡.
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/out?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
     * {
     ...
     */
    /**
     * @api {get} /coach/class/about-month-day?accesstoken=666   预约表(月)
     * @apiVersion  1.0.0
     * @apiName        .预约表(月).
     * @apiGroup       class
     * @apiPermission 管理员
     * @apiParamExample {json} 请求参数
     *   GET /coach/class/about-month?accesstoken=666
     * {
     *       $time 2017-11-08
     * }
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/about-month-day?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
    {
    ...
    /**
     * @api {get} /coach/class/about-week?accesstoken=666   预约表(周)
     * @apiVersion  1.0.0
     * @apiName        12预约表(周)
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/about-month?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
    "message": "",
    ...
    /**
     * @api {get} /coach/class/about-day?accesstoken=666   预约表(日))
     * @apiVersion  1.0.0
     * @apiName        预约表(日))
     * @apiGroup       class
     * @apiPermission 管理员
     ...
     */
    /**
     * @api {get} /coach/class/about-manage-month?accesstoken=666   管理预约表(月)
     * @apiVersion  1.0.0
     * @apiName        43管理预约表(月) 返回点 两个月公用一个的方法
     * @apiGroup       class
     * @apiPermission 管理员
     * @apiParamExample {json} 请求参数
     *   GET /coach/class/about-manage-month?accesstoken=666
     * {
     *        start  开始时间戳
     *        end    结束时间戳
     ...
     * <span><strong>邮    箱：</strong></span>zhangxiaobing@itsprts.club
     * <span><strong>创建时间：</strong></span>2017/12/12
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/about-manage-month?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
     *
    "message": "",
     ...
     *  }
     */
    public function actionAboutManageMonth($start, $end)
    {
        $manage   = Yii::$app->request->get('manage', '0');
        if ($manage ==1){
...
//        return $abouts ;
    ...
    /**
     * @api {get} /coach/class/about-manage-week?accesstoken=666   管理预约表(周)
     * @apiVersion  1.0.0
     * @apiName        2管理预约表(周)
     * @apiGroup       class
     * @apiPermission 管理员
...
//        $v = Admin::find()->alias('a')->where(['a.id'=>$this->userId])->joinWith('auth a')->all();
        ...
        $venuesId   =json_decode(Auth::findOne(['role_id' => $roleId])->venue_id);
...
//           unset($day);
    ...
    /**
     * @api {get} /coach/class/about-manage-day?accesstoken=666   管理预约表(日))
     * @apiVersion  1.0.0
     * @apiName        管理预约表(日))
     * @apiGroup       class
     * @apiPermission 管理员
    ...
    /**
     * @api {get} /coach/class/cancel?accesstoken=666   12取消预约
     * @apiVersion  1.0.0
     * @apiName        12取消预约
     * @apiGroup       class
     * @apiPermission 管理员
     * @apiParamExample {json} 请求参数
     *   GET /coach/class/acancel?accesstoken=666
     * {
     *       id  上课ID
     *
     * }
     ...
     * @apiSampleRequest  http://apiqa.aixingfu.net/coach/class/cancel?accesstoken=666
     * @apiSuccess (返回值) {json} data
     * @apiSuccessExample {json}返回值详情（成功）
    {
    "code": 1,
